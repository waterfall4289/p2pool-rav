...
nets = dict(
    ...
    grandcoin=math.Object(
        ...
        BLOCK_EXPLORER_URL_PREFIX='http://grandcoin.org/blocks/index.php?block_hash=',
        ADDRESS_EXPLORER_URL_PREFIX='http://grandcoin.org/blocks/index.php?address=', #nope, not supported!
        TX_EXPLORER_URL_PREFIX='http://grandcoin.org/blocks/index.php?transaction=',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.03e8,
    ),
