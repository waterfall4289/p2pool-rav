...
nets = dict(
	...
	NEW_SHARE_PERIOD=20, # seconds
        ...
        PERSIST=False,
        WORKER_PORT=7977,
        BOOTSTRAP_ADDRS='p2pool-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net doge.dtdns.net pool.hostv.pl p2pool.org p2pool.gotgeeks.com p2pool.dndns.net solidpool.org'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
    ...
    digitalcoin=math.Object(
        ...
        PERSIST=False,
        WORKER_PORT=8810,
        BOOTSTRAP_ADDRS='p2pool-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net doge.dtdns.net pool.hostv.pl p2pool.org p2pool.gotgeeks.com p2pool.dndns.net solidpool.org dgc.xpool.net'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
    ...
    casinocoin=math.Object(
        ...
        PERSIST=False,
        WORKER_PORT=8840,
        BOOTSTRAP_ADDRS='csc.xpool.net bigiron.homelinux.com p2pool-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net doge.dtdns.net pool.hostv.pl p2pool.org p2pool.gotgeeks.com p2pool.dndns.net solidpool.org'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
    ...
    asiccoin=math.Object(
        ...
        PERSIST=False,
        WORKER_PORT=9433,
        BOOTSTRAP_ADDRS='japool.com:13432 p2pool-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net doge.dtdns.net pool.hostv.pl p2pool.org p2pool.gotgeeks.com p2pool.dndns.net solidpool.org'.split(' '),
    ...
    netcoin=math.Object(
        ...
        TARGET_LOOKBEHIND=20, # shares
        SPREAD=50, # blocks
        IDENTIFIER='f036cd367fa210be'.decode('hex'),
        PREFIX='4f058a12f85310aa'.decode('hex'),
        P2P_PORT=8310,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=False,
